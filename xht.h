...
/* simple string->void* hashtable, very static & bare minimal, but efficient */
...
/* ooh! unlike set where key/val is in caller's mem, here they are copied into
 * xht and free'd when val is 0 or xht_free()
 */
